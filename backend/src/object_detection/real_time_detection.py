...
fps_avg_len = 200
img_count = 0
frame_save_count = 0  # To track saved frames
...
while True:
    ...
    for i in range(len(detections)):
        ...
        if conf > min_thresh:
            ...
            object_count += 1
            object_detected = True  # Mark that at least one object has been detected

    # Save the frame if any object was detected
    if object_detected:
        frame_filename = os.path.join(output_folder, f'detected_frame_{frame_save_count}.png')
